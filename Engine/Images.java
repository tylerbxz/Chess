...
public class Images {
    ...
    public static void loadAll() {
        ...
        try {
            whiteRook = ImageIO.read(new File("src/images/whiteRook.png"));
            whiteKnight = ImageIO.read(new File("src/images/whiteKnight.png"));
            whiteBishop = ImageIO.read(new File("src/images/whiteBishop.png"));
            whiteQueen = ImageIO.read(new File("src/images/whiteQueen.png"));
            whiteKing = ImageIO.read(new File("src/images/whiteKing.png"));
            whitePawn = ImageIO.read(new File("src/images/whitePawn.png"));
            blackRook = ImageIO.read(new File("src/images/blackRook.png"));
            blackKnight = ImageIO.read(new File("src/images/blackKnight.png"));
            blackBishop = ImageIO.read(new File("src/images/blackBishop.png"));
            blackQueen = ImageIO.read(new File("src/images/blackQueen.png"));
            blackKing = ImageIO.read(new File("src/images/blackKing.png"));
            blackPawn = ImageIO.read(new File("src/images/blackPawn.png"));
            boardImg = ImageIO.read(new File("src/images/board.png"));
